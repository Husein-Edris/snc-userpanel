...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.php" class="h2 mb-0">SNC<span class="text-primary">.</span> </a>
            </h1>
          </div>
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li><a href="#home-section" class="nav-link">Home <?php //echo $_SESSION['userid'] ?></a></li>
                ...
                <?php if( isset($_SESSION['username']) && !empty($_SESSION['username']) )
                {
                  ?>
                    <li class="has-children">
                      <a class="nav-link userDrop"  <?php //echo  $_SESSION['showstyle'];?> c ><i class="fa-solid fa-user"></i></a>
                      <ul class="dropdown">
                        <li><a href="#" class="nav-link"
                        onclick="document.location.href = 'profile/user-profile.php';">Profile</a></li>
                        <li>
                  ...
                  <?php }else{ ?>
                    ...
                    <li><a href="#" id="Login" class="nav-link" onclick="document.location.href = 'login/login.php';">Login</a></li>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/hero_2.png);" data-aos="fade"
      id="home-section">
          ...
          <div class="col-md-10 mt-lg-5 text-center">
            <div class="single-text owl-carousel">
              <div class="slide">
                ...
                <p class="mb-5 desc" data-aos="fade-up" data-aos-delay="100">Our mobile banking solution was inspired by
                  our customers.</p>
              ...
              <div class="slide">
                ...
                <p class="mb-5 desc" data-aos="fade-up" data-aos-delay="100">Arranging your own financing can help you
                  avoid that markup, and help you make sure you're getting the best deal possible.</p>
              </div>

              <div class="slide">
                <h1 class="text-uppercase" data-aos="fade-up">Savings Accounts</h1>
                <p class="mb-5 desc" data-aos="fade-up" data-aos-delay="100">When it comes to savings accounts, take a
                  close look at high-yield savings accounts.</p>
              </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
            <div class="mb-4">
              <h3 class="h3 mb-4 text-black">Loan Calculation</h3>
              <p>Good advice is never as helpful as an interest-free loan.</p>

            </div>

            <div class="mb-4">
              <ul class="list-unstyled ul-check success">
                <li>Quick to borrow is always slow to pay.</li>
                <li>A rolling loan gathers no loss.</li>
                <li>Let's get one thing straight.</li>
              </ul>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <p class="lead" data-aos="fade-up" data-aos-delay="100">‘‘Never spend your money before you have it.’’</p>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            <figure class="circle-bg">
              <img src="images/hero_1.jpeg" alt="Free Website Template by Free-Template.co" class="img-fluid">
            </figure>
          </div>
          <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
            ...
            <p>Happiness is yours in the here and now. The painful states of anxiety and loneliness are abolished
              permanently. Financial affairs are not financial problems. You are at ease with yourself. You are not at
              the mercy of unfulfilled cravings. Confusion is replaced with clarity. There is a relieving answer to
              every tormenting question. You possess a True Self. Something can be done about every unhappy condition.
              While living in the world you can be inwardly detached from its sorrows to live with personal peace and
              sanity..</p>

            <p>Many people who say they have financial problems really mean that they want more than they need.</p>
